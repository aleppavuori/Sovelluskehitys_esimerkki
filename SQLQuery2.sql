...
CREATE TABLE tilauksen_tuotteet (id INTEGER IDENTITY(1,1) PRIMARY KEY, tilaus_id INTEGER REFERENCES tilaukset ON DELETE CASCADE, tuotetiedot_id INTEGER REFERENCES tuotetiedot ON DELETE CASCADE, toimitettu BIT DEFAULT 0);
